...
class Rectangl;
class VulkanRectangleMultiDrawScheme : public RenderSchemeFactory
{
public:
    VulkanRectangleMultiDrawScheme(BaseRenderer* p_Renderer);
    virtual ~VulkanRectangleMultiDrawScheme();
...
private:
    ...
    void PrepareMultiDrawData(Rectangl* p_Rectangle);
#else
